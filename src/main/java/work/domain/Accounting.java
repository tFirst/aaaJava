...
public class Accounting {
    ...
    public int checkDateAndVolume(String login, String sD, String eD, String vol) throws SQLException {
        ...
        logger.trace("Trying to adding data in accounting table");
        ...
        logger.trace("Success adding start date: {}, end date: {} and volume: {} for user {}", sD, eD, vol, login);
